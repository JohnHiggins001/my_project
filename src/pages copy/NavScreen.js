...
export default class NavScreen extends React.Component {
    ...
    render() {
        ...
        let showData = navigation.state.params
        return (
            <View style={styles.container}>
                {/* <Button title="Show me more of the app" onPress={this._showMoreApp} /> */}
                {/* <Button title="Actually, sign me out :)" onPress={this._signOutAsync} /> */}
                <TouchableOpacity
                    style={{ alignItems: 'center', justifyContent: 'center', borderRadius: 8, backgroundColor: 'black', height: 50, marginBottom: 15, marginLeft: 15, marginRight: 15, marginTop: 10, padding: 5 }}
                    onPress={() => {
                    ...
                    <Text style={{ color: 'white', fontSize: 16 }}>去BottomTab页面</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ alignItems: 'center', justifyContent: 'center', borderRadius: 8, backgroundColor: 'black', height: 50, marginBottom: 15, marginLeft: 15, marginRight: 15, marginTop: 10, padding: 5 }}
                    onPress={() => {
                    ...
                    <Text style={{ color: 'white', fontSize: 16 }}>去TopTab页面</Text>
                </TouchableOpacity>
                <Text style={{ textAlign: 'center', padding: 10 }} onPress={() => {
                ...
                }}>{showData.name + showData.age + showData.sex}</Text>
                <SectionList
                    style={{ flex: 1 }}
                    sections={CITY_NAMES}
